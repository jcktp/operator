...
# ── 3d. Python 3.12 (required for TensorFlow / DeepFace) ─────────────────────
set_status "Ensuring Python 3.12…"
...
# ── 3e. Face recognition service ─────────────────────────────────────────────
FACE_PID=0
FACES_VENV=".venv-faces"
FACES_SKIP=false
set_status "Setting up facial recognition…"
...
# Reuse the faces venv — shares Pillow, numpy, scipy
