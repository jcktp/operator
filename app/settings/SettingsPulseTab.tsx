...
export default function SettingsPulseTab({
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-5 space-y-4">
      <div>
        <h2 className="text-sm font-semibold text-gray-900 dark:text-zinc-50">Social accounts</h2>
        <p className="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">Sign in to see your home timeline in Pulse. Not required for public profile feeds.</p>
      </div>

      <div className="space-y-2">
        <p className="text-xs font-semibold text-gray-700 dark:text-zinc-200">Bluesky</p>
        <div className="grid grid-cols-2 gap-2">
          <div>
            <label className="block text-xs font-medium text-gray-600 dark:text-zinc-300 mb-1">Handle</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 dark:text-zinc-300 mb-1">App password</label>
            <input
              type="password"
              ...
              className="w-full border border-gray-200 dark:border-zinc-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-zinc-400 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder-zinc-500 font-mono"
            />
          </div>
        </div>
        <p className="text-[11px] text-gray-400 dark:text-zinc-500">Generate an app password at bsky.app → Settings → App Passwords. Your home timeline will appear in Pulse automatically when you save.</p>
      </div>

      <div className="space-y-2 pt-3 border-t border-gray-100 dark:border-zinc-800">
        <p className="text-xs font-semibold text-gray-700 dark:text-zinc-200">Mastodon</p>
        <div>
        ...
        <p className="text-[11px] text-gray-400 dark:text-zinc-500">Generate at your instance → Preferences → Development → New application (read:statuses scope). Then add a Mastodon feed in Pulse with URL set to your instance domain, e.g. <code className="font-mono">mastodon.social</code>.</p>
      </div>
