...
export default function StepWelcome({ userName, onNext }: Props) {
 ...
 <div className="w-12 h-12 bg-[var(--ink)] rounded-2xl flex items-center justify-center">
 ...
 <div className="bg-[var(--amber-dim)] border border-[var(--amber)] rounded-xl px-5 py-4 space-y-1.5">
