  ...
  return (
    <div
      className="max-w-3xl mx-auto px-8 py-6
        ...
        [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:text-gray-900 dark:[&_h1]:text-zinc-50 [&_h1]:mt-6 [&_h1]:mb-3
        [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-gray-900 dark:[&_h2]:text-zinc-50 [&_h2]:mt-5 [&_h2]:mb-2
        [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-gray-800 dark:[&_h3]:text-zinc-100 [&_h3]:mt-4 [&_h3]:mb-1
        [&_p]:text-[15px] [&_p]:text-gray-700 dark:[&_p]:text-zinc-200 [&_p]:leading-relaxed [&_p]:mb-3
        [&_a]:text-indigo-600 [&_a]:underline
        [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-3
        [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-3
        [&_li]:text-[15px] [&_li]:text-gray-700 dark:[&_li]:text-zinc-200 [&_li]:mb-1
