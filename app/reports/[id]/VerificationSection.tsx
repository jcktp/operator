  ...
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        ...
        <span className="flex-1 text-sm text-gray-700 leading-snug">{item.claim}</span>
      ...
      {open && (
        <div className="px-4 pb-4 ml-3 space-y-3">
          <div>
            <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Evidence needed</p>
            <p className="text-sm text-gray-600 leading-relaxed">{item.evidenceNeeded}</p>
          </div>
          {item.suggestedSources.length > 0 && (
            <div>
              <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1.5">Suggested sources</p>
  ...
  return (
    <section>
      <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3 flex items-center gap-1.5">
        <CheckSquare size={11} />
        Verification
        <span className="ml-1 px-1.5 py-0.5 rounded bg-amber-50 text-amber-600 text-xs font-medium normal-case tracking-normal">
