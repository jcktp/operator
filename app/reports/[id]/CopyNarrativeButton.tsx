...
export default function CopyNarrativeButton({ title, area, directName, reportDate, summary, metrics, insights, questions }: Props) {
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded-[4px] border border-[var(--border)] bg-[var(--surface)] text-xs font-medium text-[var(--text-subtle)] hover:border-[var(--border-mid)] hover:text-[var(--text-bright)] transition-colors"
 >
