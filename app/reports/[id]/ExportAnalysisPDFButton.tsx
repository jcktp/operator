 ...
 * { box-sizing: border-box; margin: 0; padding: 0; }
 ...
 className="shrink-0 inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-[4px] border border-[var(--border)] bg-[var(--surface)] text-[var(--text-subtle)] hover:text-[var(--text-bright)] hover:border-[var(--border-mid)] transition-colors"
 >
 <FileDown size={13} />
 Export PDF
 </button>
