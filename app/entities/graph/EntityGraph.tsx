...
export default function EntityGraph({ initialData }: { initialData: GraphData }) {
 ...
 {loading && (
 <div className="absolute inset-0 flex items-center justify-center bg-[var(--surface)]/60 z-10">
 ...
 <div className="absolute bottom-3 left-3 bg-[var(--surface)] border border-[var(--border)] rounded-[4px] px-3 py-1.5 text-xs text-[var(--text-subtle)] shadow pointer-events-none">
 ...
 <span key={type} className="flex items-center gap-1 text-xs text-[var(--text-muted)] bg-[var(--surface)] border border-[var(--border)] rounded px-2 py-0.5">
