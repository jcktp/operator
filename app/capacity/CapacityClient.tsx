...
const numCls = 'h-8 border border-[var(--border)] rounded-[4px] px-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500/30 w-24 text-right'
...
export default function CapacityClient() {
 ...
 <span className="text-[11px] text-[var(--text-muted)]">Avg complexity: <span className="font-medium text-[var(--text-body)]">{avgComplexity.toFixed(2)}×</span></span>
 </div>
 <p className="text-xs text-[var(--text-muted)]">
 ...
 filterDept === d ? 'bg-[var(--ink)] text-white border-transparent' : 'border-[var(--border)] text-[var(--text-muted)]')}>
