/**
 * Per-item upload processor — runs AI analysis for a single queued upload.
 * Called by the worker in upload-queue.ts after a job item is dequeued.
 */
...
import { analyzeReport, compareReports, checkResolvedFlags, extractMerged, compareDocumentsJournalism } from './ai'
